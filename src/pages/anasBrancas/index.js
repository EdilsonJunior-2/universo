...
export default class anasBrancas extends Component {
    ...
    loadEstrelas = async () => {
        const response = await api.get(`/anasBrancas`);
        const anasBrancas = response.data.anas_brancas;
        console.log(anasBrancas);
        this.setState({ estrelas: anasBrancas });
    }
