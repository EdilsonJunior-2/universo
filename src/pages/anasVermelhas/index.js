...
export default class anasVermelhas extends Component {
    ...
    loadEstelas = async () => {
        const response = await api.get(`/anasVermelhas`);
        const anasVermelhas = response.data.anas_vermelhas;
        console.log(anasVermelhas);
        this.setState({ estrelas: anasVermelhas });
    }
