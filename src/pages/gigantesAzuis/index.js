...
export default class gigantesAzuis extends Component {
    ...
    loadEstelas = async () => {
        const response = await api.get(`/gigantesAzuis`);
        const gigantesAzuis = response.data.gigantes_azuis;
        console.log(gigantesAzuis);
        this.setState({ estrelas: gigantesAzuis });
    }
