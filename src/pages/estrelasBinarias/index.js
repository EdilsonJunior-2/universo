...
export default class estrelasBinarias extends Component {
    ...
    loadEstrelas = async () => {
        const response = await api.get(`/estrelasBinarias`);
        const estrelasBinarias = response.data.estrelas_binarias;
        console.log(estrelasBinarias);
        this.setState({ estrelas: estrelasBinarias });
    }
